...
/**
 * This class provides resources and data used for the device recollateralization use case.
 */
public class DeviceRecolProvisionInfoViewModel extends ProvisionInfoViewModel {
    private static final int MANDATORY_HEADER_TEXT_ID = R.string.device_used_as_collateral;
    private static final int SUB_HEADER_TEXT_ID = R.string.enroll_your_device_recol_subheader;
    ...
    public DeviceRecolProvisionInfoViewModel() {
